      ...
      <section className='about'>
        ...
        <div className='container flex mtop'>
          <div className='left row'>
            ...
            <p>Whether you're a first-time buyer or a seasoned investor, we're here to make your home-hunting journey a seamless and enjoyable experience. So, welcome to Gharaana—where your happiness is our top priority. Let's embark on this exciting journey together and find your happy place!</p>
            <p>Happy Homehunting!</p>
            <p>Jugraunaq Singh</p>
            <p>Founder, Gharaana</p>
