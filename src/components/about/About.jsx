      ...
      <section className='about'>
        ...
        <div className='container flex mtop'>
          <div className='left row'>
            ...
            <p>Welcome to Spaces by Parth Sharma! I'm Parth Sharma, the founder and driving force behind this venture. My journey began with a simple yet profound goal: to empower individuals from all walks of life, from the middle class to the affluent, in their pursuit of the perfect home, all while keeping affordability at the forefront.</p>
            ...
            <p>Parth Sharma</p>
            <p>Founder, Spaces by Parth Sharma</p>
